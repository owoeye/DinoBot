...
# # open dinosaur game
# webbrowser.get("chrome").open("https://elgoog.im/dinosaur-game/")

# set size of the image to be taken
x, y, width, height = 0, 820, 1920, 520
...
y_search1, y_search2, x_start, x_end = 420, 315, 650, 800
y_search_for_bird = 230
...
while True:
    ...
    # print(f"interval time, {interval_time} = {current_jumping_time} - {last_jumping_time}")
